 ...
 */
export type VendorErrorCode = 'VENDOR_NOT_FOUND' | 'VALIDATION_ERROR' | 'UNAUTHORIZED' | 'FORBIDDEN' | 'RATE_LIMIT_EXCEEDED' | 'TOO_MANY_REQUESTS' | 'INTERNAL_SERVER_ERROR';
/**
 * Types d'événements supportés pour l'estimation budgétaire.
 */
export type EventType = 'wedding' | 'birthday' | 'corporate' | 'baptism' | 'conference' | 'concert' | 'other';
/**
